...
dnf5 install -y cockpit cockpit-machines helix gcc llvm chezmoi rclone adw-gtk3-theme qt6ct virt-manager android-tools podman-machine podman-tui libvirt qemu-kvm qemu edk2-ovmf guestfs-tools podman-compose crun crun-vm
